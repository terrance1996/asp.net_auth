<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="TaskAuth.HomePage" %>
...
<html>
    ...
    <body class="page-header-fixed compact-menu page-horizontal-bar">
        ...
        <main class="page-content content-wrap" runat="server">
            <div class="navbar">
                    ...
                    <div class="topmenu-outer">
                        <div class="top-menu">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        <span class="user-name"><%=Session["username"] %><i class="fa fa-angle-down"></i></span>
                                    ...
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        ...
                                        <li role="presentation">
                                                ...
                                                <asp:Button CssClass="btn btn-default" ID="logoutBtn" runat="server" Text="Logout" OnClick="logoutBtn_Click" />
                                        </li>
                                    </ul>
                                </li>
                                <li>
